    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo e(Form::open(['route' => 'users.pdf', 'class' => 'form', 'target' => '_blank'])); ?>
                    ...
                    <div class="form-group">
                        <?php echo e(Form::select('assignment_id', $assignmentsForSelect, null, ['class' => 'form-control select2', 'style' => 'width: 100%', 'placeholder' => 'TODAS AS FUNÇÕES'])); ?>
