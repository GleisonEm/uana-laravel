<div class="modal fade" id="update<?php echo e($institute->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo e(Form::model($institute, ['route' => ['institutes.update', $institute->id], 'class' => 'form form-prevent-multiple-submits', 'method' => 'PUT'])); ?>
