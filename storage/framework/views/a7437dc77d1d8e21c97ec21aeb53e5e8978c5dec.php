<div class="modal fade" id="password<?php echo e($user->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo e(Form::model(Auth::user(), ['route' => ['users.password', $user->id], 'class' => 'form form-prevent-multiple-submits', 'method' => 'PUT'])); ?>
                    ...
                    <div class=text-right>
                        <?php echo e(Form::submit("Redefinir", ['class' => 'btn btn-primary button-prevent-multiple-submits'])); ?>
