    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {{ Form::open(['route' => 'users.pdf', 'class' => 'form', 'target' => '_blank']) }}
                    ...
                    <div class="form-group">
                        {{ Form::select('assignment_id', $assignmentsForSelect, null, ['class' => 'form-control select2', 'style' => 'width: 100%', 'placeholder' => 'TODAS AS FUNÇÕES']) }}
                    </div>
                    <div class="form-group">
