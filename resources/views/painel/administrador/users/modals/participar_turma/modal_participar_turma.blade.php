    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {{ Form::model(Auth::user(), ['route' => ['users.team_user'], 'class' => 'form form-prevent-multiple-submits', 'method' => 'PUT']) }}
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                {{ Form::label('key', 'Insira o código') }}
                    ...
                    <div class=text-right>
                        {{ Form::submit("Participar", ['class' => 'btn btn-primary']) }}
