<div class="modal fade" id="deferir{{$protocol_document->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title text-center"><b>Confirma o Deferimento ?</b></h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class=text-right>
                                {{ Form::submit('Confirmar Deferimento', ['class' => 'btn btn-success button-prevent-multiple-submits']) }}
