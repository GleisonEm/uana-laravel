<div class="modal fade" id="receive{{$protocol->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title text-center"><b>Confirma o Recebimento dos Documentos ? </b></h4>
            </div>
            <div class="modal-body">
                {{ Form::model($protocol, ['route' => ['documentos.receive', $protocol->id], 'class' => 'form form-prevent-multiple-submits', 'method' => 'PUT']) }}
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::textarea('observacao_confirmacao', null, array('class' => 'form-control', 'style' => 'resize:none', 'rows' => '5')) }}
                    </div>                   
                    <hr>
                    <div class="row">
